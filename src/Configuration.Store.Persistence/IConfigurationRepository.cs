...
namespace Configuration.Store.Persistence
{
    public interface IConfigurationRepository
    {
        ...
        Task<StoredConfig> GetConfiguration(string key);
        Task<StoredConfig> GetConfiguration(string key, Version version);
        Task AddNewConfiguration(string key, string dataType, DateTime createdAt);
        Task DeleteConfiguration(string key);
        Task DeleteConfigurationVersion(string key, Version version);
